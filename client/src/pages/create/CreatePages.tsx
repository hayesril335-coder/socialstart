...
export function MediaCreatePage(){
 const location=useLocation(),navigate=useNavigate(),input=useRef<HTMLInputElement>(null),video=useRef<HTMLVideoElement>(null),stream=useRef<MediaStream|null>(null),recorder=useRef<MediaRecorder|null>(null),chunks=useRef<Blob[]>([])
 ...
 const chooseFile=(file?:File)=>{if(file)setPreview(URL.createObjectURL(file))}
