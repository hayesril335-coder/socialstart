...
import { CheckoutPage, ProductDetailsPage, StorePage } from '../pages/store/StorePages'
export function AppRoutes(){return <Routes>
 ...
 <Route element={<MainAppLayout/>}><Route index element={<Navigate to="/search"/>}/><Route path="/search" element={<SearchPage/>}/><Route path="/post/:postId" element={<PostDetailsPage/>}/><Route path="/profile" element={<ProfilePage/>}/><Route path="/profile/:username" element={<ProfilePage/>}/><Route path="/profile/:username/story" element={<PostDetailsPage/>}/>
 ...
 <Route path="/settings/wallet" element={<SettingsDetailPage type="Wallet"/>}/><Route path="/store/:username" element={<StorePage/>}/><Route path="/store/:username/product/:productId" element={<ProductDetailsPage/>}/><Route path="/store/:username/manage" element={<SettingsDetailPage type="Manage store"/>}/><Route path="/store/:username/product/new" element={<SettingsDetailPage type="New product"/>}/><Route path="/checkout" element={<CheckoutPage/>}/><Route path="/notifications" element={<NotificationsPage/>}/>
 </Route><Route path="*" element={<Navigate to="/search"/>}/>
 </Routes>}
